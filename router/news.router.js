...
router.post('/create', checkAuth(['ADMIN']), newsController.create);
...
router.put('/editNews/:id', checkAuth(['ADMIN']), newsController.editNews);
...
router.delete('/delete/:id', checkAuth(['ADMIN']), newsController.deleteNews);
...
router.put('/slider', checkAuth(['ADMIN']), newsController.slider);
